...
use \weworkapi\api\datastructure\serviceprovider\GetLoginInfoRsp;
use \weworkapi\api\datastructure\serviceprovider\GetRegisterInfoRsp;
use \weworkapi\api\datastructure\serviceprovider\SetAgentScopeRsp;
use \think\Cache;
...
class ServiceProviderAPI extends API
{
    ...
    { 
        if ( ! Utils::notEmptyStr($this->provider_access_token)) {   //jiang.ding注释
//        if ( !Cache::get($this->cacheKey['provider_access_token'])) {    //jiang.ding新增
